...
<html class="no-js">
  ...
  <body>
    <div style="background-image: url('assets/img/ueshsgif.gif')" class="main"> 
      ...
      <div class="container">
      <div class="center">
        <label class="cursive" style="font-size: 90px; color: #FFFFFF; font-weight: bold;">GOOD BYE, <span id = "teachername"></span></label></div>
        <h2 class="sub">Visit EDUTOO again soon! </h2>
        <div class="mailing-list">
          <form action="login.php">
          <button class="button" style="vertical-align:middle" onclick = "logout();"><span class="sub">Logout </span></button>
          </form>
        </div>
      </div>
      <div class="footer">
    ...
    <script src = "assets/program-js/logout.js"></script>
    <script>
