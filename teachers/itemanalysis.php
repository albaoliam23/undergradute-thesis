...
<head>
    ...
    <title>ITEM ANALYSIS | EDUTOO | INSTRUCTOR MODULE</title>
...
<body>
      ...
      *********************************************************************************************************************************************************** -->
        ...
        <section id="main-content">
            <section class="wrapper">
                ...
                <div class="row">
                    <img src="assets/img/itemanalysisgif.gif" style="width: 100%;">
                            ...
                            <div class="form-panel">
                              <div class = "form-horizontal">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                        <h3><i aria-hidden="true" class="fa fa-pencil-square-o"></i> Item Analysis</h3>
                                          <table class="table table-striped table-advance table-hover" id = "tbl_analysis">
                                              <thead>
                                              <tr>
                                              ...
                                              <tfoot>
                                                <tr>
                                                    <td>Expected number of Examinees:</td>
                                                    <td id = "exp_num"></td>
                                                </tr>
                                                <tr>
                                                    <td>Formula(for each question)</td>
                                                    <td>Difficulty = Wrong/Total Number of Students in the Group</td>
                                                </tr>
                                              </tfoot>
                                          </table>
                                        </div>
    ...
    <script src="assets/program-js/itemanalysis.js"></script>
</body>
