...
<html lang="en">
   ...
   <body>
                  ...
                  <div class="row mt">
                     <div class="form-panel">
                        <div class="form-group">
                           <h3><i aria-hidden="true" class="fa fa-list"></i> <span id = "studentName"></span></h3>
                           <br>
                           <table cellspacing="0" class="table table-striped table-bordered table-hover" id="tbl_grades">
                              <thead>
                                 <tr class = "info">
                                    <th align = "center">Activity</th>
                                    <th align = "center">Time to Read(minutes)</th>
                                    <th align = "center">Time on Quiz(minutes)</th>
                              ...
                              <tfoot id = "statistics">
                                <tr>
                                  <td colspan = 5 align = "center" class = "info">Time on Read Description</td>
                                </tr>
                                <tr>
                                  <td colspan = 2>Minimum Time To Read(minutes)</td>
                                  <td colspan = 3 id = "mintimetoread"></td>
                                </tr>
                                <tr>
                                  <td colspan = 2>Maximum Time To Read(minutes)</td>
                                  <td colspan = 3 id = "maxtimetoread"></td>
                                </tr>
                                <tr>
                                  <td colspan = 2>Average Time To Read(minutes)</td>
                                  <td colspan = 3 id = "avgtimetoread"></td>
                                </tr>
                                <tr>
                                  <td colspan = 5 align = "center" class = "info">Time on Quiz Description</td>
                                </tr>
                                <tr>
                                  <td colspan = 2>Minimum Time On Quiz(minutes)</td>
                                  <td colspan = 3 id = "mintimetoquiz"></td>
                                </tr>
                                <tr>
                                  <td colspan = 2>Maximum Time On Quiz(minutes)</td>
                                  <td colspan = 3 id = "maxtimetoquiz"></td>
                                </tr>
                                <tr>
                                  <td colspan = 2>Average Time On Quiz(minutes)</td>
                                  <td colspan = 3 id = "avgtimetoquiz"></td>
                                </tr>
                                <tr>
                                  <td colspan = 5 align = "center" class = "info">Performance Description</td>
                                </tr>
                                <tr>
                                  <td colspan = 2>Minimum Score</td>
                                  <td colspan = 3 id = "minperf"></td>
                                </tr>
                                <tr>
                                  <td colspan = 2>Maximum Score</td>
                                  <td colspan = 3 id = "maxperf"></td>
                                </tr>
                                <tr>
                                  <td colspan = 2>Average Score</td>
                                  <td colspan = 3 id = "avgperf"></td>
                                </tr>
                              </tfoot>
                              <tbody id = "rows"></tbody>
                           </table>
      ...
      <script src="assets/program-js/studassessment.js"></script>
   </body>
</html>